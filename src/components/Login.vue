      ...
      <div class="frame-group">
        ...
        <div class="frame-container">
          <div class="input-container">
            ...
            <input class="input-field" type="text" placeholder="Escribe tu usuario" v-model="username" @keyup.enter="onEnter" />
            <input class="input-field" type="password" placeholder="Escribe tu contraseña" v-model="password" @keyup.enter="onEnter" />
         
          </div>
          <div class="frame-wrapper">
            <div class="frame-div" @click="login">
              <div class="iniciar-sesin-wrapper">
                <div class="iniciar-sesin">INICIAR SESIÓN</div>
              </div>
              <div class="no-tienes-una-container" @click="showRegister">
                <p class="no-tienes-una">¿No tienes una cuenta?</p>
                <p class="regstrate-ahora">Regístrate ahora.</p>
              </div>
            </div>
          </div>
        </div>
