...
<!------- INICIO LISTA DE COMANDOS ADMIN BY MIUSTICAT------------------------------------------------------------------------------------------------------------------------------------------------->
                <div class="row d-flex justify-content-center"
                    style="margin-left: 15rem !important; margin-top: 5.0vh; height:90vh; overflow-x: auto;"
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12 mt-1">
                            <div class="box box-default">
                                <div class="card card-primary card-outline">
                                    <div class="card-header" style="font-family: 'Exo', sans-serif;">Staff</div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="card card-primary">
...
<th>Rango</th>
                                                            ...
                                                            <tbody v-if="admin >= 1">
                                                                <tr>
    <td>@ Mensaje</td>
    <td>Usar chat de administrador</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
    <td>/toggleachat</td>
    <td>Activar/desactivar notificaciones de administrador</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
    <td>[CTRL]</td>
    <td>Llevar jugador</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
    <td>/adminduty</td>
    <td>Iniciar/terminar servicio de administrador</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
    <td>/freeze</td>
    <td>Congelar/descongelar a un jugador</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
    <td>/whitelist</td>
    <td>Agregar/eliminar a un jugador de la lista blanca</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
    <td>/revive</td>
    <td>Revivir jugador</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
    <td>/goto</td>
    <td>Teletransportarse a un jugador</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
    <td>/gethere</td>
    <td>Teletransportar a un jugador hacia ti</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
    <td>/getcar</td>
    <td>Teletransportar un vehículo hacia ti</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
    <td>/vehiclegarage</td>
    <td>Estacionar vehículos en el garaje</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
    <td>/admingarage</td>
    <td>Acceder al garaje de administrador</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
    <td>/checkvehicles</td>
    <td>Revisar vehículos</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
    <td>/checkplayer</td>
    <td>Revisar perfil de jugador</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
...
<tr>
    <td>/getvehicleid</td>
    <td>Obtener ID de vehículo del servidor</td>
    <td>Modo de prueba del moderador</td>
</tr>
                                                                <tr>
    <td>/gointocar</td>
    <td>Teletransportarse a un vehículo</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
    <td>/gotohouse</td>
    <td>Teletransportarse a una casa</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
    <td>/veh(2)</td>
    <td>Generar/eliminar un vehículo de administrador</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
    <td>/prison</td>
    <td>Encarcelar a un jugador</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
    <td>/spectate & /stopspec</td>
    <td>Observar a un jugador / Detener observación</td>
    <td>Modo de prueba del moderador</td>
</tr>
<tr>
    <td>/nametag</td>
    <td>Ocultar etiqueta de nombre</td>
    <td>Modo de prueba del moderador</td>
</tr>
                                                            ...
                                                            <tbody v-if="admin >= 2">
                                                                <tr>
    <td>/resetweapons</td>
    <td>Restablecer armas</td>
    <td>Moderador</td>
</tr>
<tr>
    <td>/kick</td>
    <td>Expulsar a un jugador</td>
    <td>Moderador</td>
</tr>
<tr>
    <td>/save</td>
...
<tr>
    <td>/teleport</td>
    <td>Teletransportarse a una posición</td>
    <td>Moderador</td>
</tr>
<tr>
    <td>/telexyz</td>
    <td>Teletransportarse a coordenadas</td>
    <td>Moderador</td>
</tr>
<tr>
    <td>/loadipl</td>
    ...
    <td>Moderador</td>
                                                            ...
                                                            <tbody v-if="admin >= 3">
                                                                <tr>
    <td>/ban</td>
    <td>Banear a un jugador</td>
    <td>Soporte</td>
</tr>
<tr>
    <td>/setskin</td>
    <td>Establecer un skin a un jugador</td>
    <td>Soporte</td>
</tr>
<tr>
    <td>/reconnect</td>
    <td>Reconectar jugador</td>
    <td>Soporte</td>
</tr>
<tr>
    <td>/fillveh</td>
    <td>Llenar el tanque de un vehículo</td>
    <td>Soporte</td>
</tr>
<tr>
    <td>/fixveh</td>
    <td>Reparar un vehículo</td>
    <td>Soporte</td>
</tr>
<tr>
    <td>/createcoupon</td>
    <td>Crear un cupón</td>
    <td>Soporte</td>
</tr>
<tr>
    <td>/testcloth</td>
...
<tr>
    ...
    <td>Soporte</td>
                                                            ...
                                                            <tbody v-if="admin >= 4">
                                                                <tr>
    <td>/unban</td>
    <td>Desbanear a un jugador</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/unprison</td>
    <td>Sacar a un jugador de la prisión</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/set</td>
    <td>Establecer cosas, dar lider de facción, vip, etc.</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/setweather</td>
    <td>Establecer el clima</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/editgroup</td>
...
<tr>
    ...
    <td>Crear puerta de facción</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/testobject</td>
    <td>Crear objeto de prueba</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/createanimation</td>
    <td>Añadir nueva animación</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/editanimation</td>
    <td>Editar animación</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/testanim</td>
    <td>Probar animación</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/createszenario</td>
    <td>Añadir nuevo escenario</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/createhouseinterior</td>
    <td>Crear nuevo interior de casa</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/updatehouseinterior</td>
    <td>Editar interior de casa</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/createhouse</td>
    <td>Crear una nueva casa</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/asellhouse</td>
    <td>Vender una casa administrativamente</td>
    <td>Administrador</td>
</tr>

                                                               <tr>
    <td>/edithouse</td>
    <td>Editar una casa</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/housecheck</td>
    <td>Verificar una casa</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/gethouse</td>
    <td>Teletransportar una casa hacia ti</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/createhousedoor - /chd</td>
    <td>Crear una puerta de casa</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/createfurniture</td>
    <td>Crear un nuevo mueble</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/furniturecheck</td>
    <td>Verificar un mueble</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/deletefurniture</td>
    <td>Desmontar/borrar un mueble</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/createbizz</td>
    <td>Crear un nuevo negocio</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/asellbizz</td>
    <td>Vender un negocio administrativamente</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/editbizz</td>
    <td>Editar un negocio</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/createbizzdoor - /cbd</td>
    <td>Crear una puerta de negocio</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/bizzcheck</td>
    <td>Verificar un negocio</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/getbizz</td>
    <td>Teletransportar un negocio hacia ti</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/createbusroute</td>
    <td>Crear una nueva ruta de autobús</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/createbusstation</td>
    <td>Agregar una parada a la ruta de autobús</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/creategarbageroute</td>
    <td>Crear una nueva ruta de basura</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/createtaxiposition</td>
    <td>Crear una nueva posición de taxi</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/creategangzone</td>
    <td>Crear una nueva zona de pandillas</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/updategangzone</td>
    <td>Actualizar zona de pandillas</td>
    <td>Administrador</td>
</tr>
                                                               <tr>
    <td>/createvehicle</td>
    <td>Agregar un vehículo a un negocio</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/deleteallveh2</td>
    <td>Borrar todos los vehículos administrativos</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/createfactionvehicle - /cfv</td>
    <td>Crear un vehículo de facción</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/deletefactionvehicle - /dfv</td>
    <td>Borrar un vehículo de facción</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/changefactionvehiclecolor - /cfvc</td>
    <td>Modificar el color de un vehículo de facción</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/createfactiondoor - /cfd</td>
    <td>Crear una puerta de facción</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/closestdoorhash - /cdh</td>
    <td>Identificar el hash de una puerta cercana</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/gotodoor</td>
    <td>Teletransportarse a una puerta</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/vehicleengine</td>
    <td>Darle daños al motor de un vehículo</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/invisible</td>
    <td>Volver invisible</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/agl</td>
    <td>Asignar licencias</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/aggl</td>
    <td>Asignar licencias de grupos/empresas</td>
    <td>Administrador</td>
</tr>
<tr>
    <td>/eventucn</td>
    <td>Adoptar/abandonar identidad encubierta de evento</td>
    <td>Administrador</td>
</tr>
                                     ...
                                     <tr>
    <td>/aban</td>
    <td>Ban de Anticheat</td>
    <td>Administrador Principal</td>
</tr>
<tr>
    <td>/screenshot</td>
    <td>Tomar captura de pantalla de un jugador</td>
    <td>Administrador Principal</td>
</tr>
<tr>
    <td>/devmodus</td>
    <td>Activar/Desactivar modo de desarrollo</td>
    <td>Administrador Principal</td>
</tr>
<tr>
    <td>/sonic</td>
    <td>Activar/Desactivar modo Sonic</td>
    <td>Administrador Principal</td>
</tr>
<tr>
    <td>/rtune</td>
    <td>Sintonizar un vehículo al azar</td>
    <td>Administrador Principal</td>
</tr>
<tr>
    <td>/funmodus</td>
    <td>Activar/Desactivar modo de diversión</td>
    <td>Administrador Principal</td>
</tr>
<tr>
    <td>/saveall</td>
    <td>Guardar todo el servidor</td>
    <td>Administrador Principal</td>
</tr>
<tr>
    <td>/createfire</td>
    <td>Crear un incidente de bomberos</td>
    <td>Administrador Principal</td>
</tr>
<tr>
    <td>/startfire</td>
    <td>Iniciar un incidente de bomberos</td>
    <td>Administrador Principal</td>
</tr>
<tr>
    <td>/startlotto</td>
    <td>Iniciar sorteo de lotería</td>
    <td>Administrador Principal</td>
</tr>
<tr>
    <td>/clearchat</td>
    <td>Borrar historial de chat</td>
    <td>Administrador Principal</td>
</tr>
        ...
        <!------- FIN LISTA DE COMANDOS ADMIN BY MIUSTICAT-->
